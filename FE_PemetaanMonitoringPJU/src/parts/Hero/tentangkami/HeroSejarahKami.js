      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-start justify-center h-full text-white mt-7 lg:px-28 px-5">
          ...
          <div className="max-w-lg">
            <h1 className="text-4xl font-semibold">Sejarah Kami</h1>
            <p className="mt-4 text-lg">
              Dari langkah awal hingga menjadi perusahaan pertama yang mengelola AJU di Indonesia melalui skema KPBU
            </p>
          </div>
        </div>
      </section>
      ...
      <div className="breadcrumb bg-gray-100 py-6 px-5 lg:px-52">
        <nav className="text-lg text-gray-600">
          <ul className="flex space-x-2">
            ...
            <li>{`>`}</li>
            <li className="text-gray-500">Sejarah Kami</li>
          </ul>
        </nav>
      </div>
    </>
...
export default HeroSejarahKami;