...
import DataRiwayatPanel from 'parts/Visitor/ManageData/DataRiwayat/DataRiwayatPanel';
    ...
    return (
      <div className="flex overflow-hidden relative">
        ...
        >
          ...
          {/* Main Content */}
          <main className="p-6">
            <h1 className="text-3xl font-bold text-green-700">Data Riwayat Panel</h1>
